...
![VS Code Installation](./img/getting-started/vscode_install.png)
...
![Vex Robotics Extension install](./img/getting-started/vex_install.png)
...
![C++ Extension](./img/getting-started/cpp_install.png)
...
![Vex Robotics Extension install](./img/getting-started/mikLibdownload.png)
...
![Import Template](./img/getting-started/import.png)
