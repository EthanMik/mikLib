...
|                | Name           |
| -------------- | -------------- |
| virtual int | **[get_height](/api/classes/classmik_1_1line#function-get-height)**() override |
| virtual int | **[get_width](/api/classes/classmik_1_1line#function-get-width)**() override |
| virtual int | **[get_x_pos](/api/classes/classmik_1_1line#function-get-x-pos)**() override |
| virtual int | **[get_y_pos](/api/classes/classmik_1_1line#function-get-y-pos)**() override |
| | **[line](/api/classes/classmik_1_1line#function-line)**(float x1, float y1, float x2, float y2, uint32_t hue, [UI_distance_units](/api/namespaces/namespacemik#enum-ui-distance-units) units) |
| | **[line](/api/classes/classmik_1_1line#function-line)**(float x1, float y1, float x2, float y2, const std::string & hex, [UI_distance_units](/api/namespaces/namespacemik#enum-ui-distance-units) units) |
| virtual void | **[render](/api/classes/classmik_1_1line#function-render)**() override |
| virtual void | **[set_height](/api/classes/classmik_1_1line#function-set-height)**(int h) override |
| virtual void | **[set_position](/api/classes/classmik_1_1line#function-set-position)**(int x, int y) override |
| virtual void | **[set_width](/api/classes/classmik_1_1line#function-set-width)**(int w) override |
| virtual void | **[set_x_pos](/api/classes/classmik_1_1line#function-set-x-pos)**(int x) override |
| virtual void | **[set_y_pos](/api/classes/classmik_1_1line#function-set-y-pos)**(int y) override |
