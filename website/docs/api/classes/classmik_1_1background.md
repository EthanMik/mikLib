...
|                | Name           |
| -------------- | -------------- |
| | **[background](/api/classes/classmik_1_1background#function-background)**(std::shared_ptr< [drawable](/api/classes/classmik_1_1drawable) > graphic) |
| virtual int | **[get_height](/api/classes/classmik_1_1background#function-get-height)**() override |
| virtual int | **[get_width](/api/classes/classmik_1_1background#function-get-width)**() override |
| virtual int | **[get_x_pos](/api/classes/classmik_1_1background#function-get-x-pos)**() override |
| virtual int | **[get_y_pos](/api/classes/classmik_1_1background#function-get-y-pos)**() override |
| virtual bool | **[needs_update](/api/classes/classmik_1_1background#function-needs-update)**() override |
| virtual void | **[render](/api/classes/classmik_1_1background#function-render)**() override |
| virtual void | **[set_position](/api/classes/classmik_1_1background#function-set-position)**(int x, int y) override |
| virtual void | **[set_x_pos](/api/classes/classmik_1_1background#function-set-x-pos)**(int x) override |
| virtual void | **[set_y_pos](/api/classes/classmik_1_1background#function-set-y-pos)**(int y) override |
