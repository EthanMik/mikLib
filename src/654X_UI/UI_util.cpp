...
std::shared_ptr<mik::drawable> UI_crt_txt(const std::string& text_label, float x, float y, uint32_t hue, mik::UI_distance_units units) {
    return std::make_shared<mik::text>(text_label, x, y, hue, units);
}
std::shared_ptr<mik::drawable> UI_crt_txt(const std::string& text_label, float x, float y, vex::color hue, mik::UI_distance_units units) {
    return std::make_shared<mik::text>(text_label, x, y, hue, units);
}
...
std::shared_ptr<mik::UI_component> UI_crt_txtbox(std::string text, uint32_t text_color, std::shared_ptr<mik::drawable> box) {
    return std::make_shared<mik::textbox>(text, text_color, box);
}

std::shared_ptr<mik::UI_component> UI_crt_txtbox(std::string text, uint32_t text_color, mik::text_align text_alignment, std::shared_ptr<mik::drawable> box) {
    return std::make_shared<mik::textbox>(text, text_color, text_alignment, box);
}
