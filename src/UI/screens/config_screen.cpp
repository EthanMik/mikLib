...
// MACRO SLOTS
    ...
    auto macro_1 = UI_crt_txtbox("Run Auto", text_alignment, macro_slot_color, UI_crt_rec(macro_slot_x_position+text_box_offset, y_start_position+text_box_offset+y_offset*1, 150, 31, macro_slot_color, UI_distance_units::pixels));
    ...
    auto macro_4_bg = UI_crt_btn(UI_crt_rec(macro_slot_x_position, y_start_position+y_offset*2, 154, 35, macro_slot_border_color, UI_distance_units::pixels), [](){ 
    ...
    macro_10_bg_tgl = UI_crt_tgl(UI_crt_rec(macro_slot_x_position, y_start_position+y_offset*4, 154, 35, macro_slot_border_color, UI_distance_units::pixels), [](){});
    auto macro_10_bg = UI_crt_btn(UI_crt_rec(macro_slot_x_position, y_start_position+y_offset*4, 154, 35, macro_slot_border_color, UI_distance_units::pixels), [](){ 
    ...
    // Opens pnematic menu
    auto macro_16_bg = UI_crt_btn(UI_crt_rec(macro_slot_x_position, y_start_position+y_offset*6, 154, 35, macro_slot_border_color, UI_distance_units::pixels), [this](){ 
...
// TEST/TUNE SLOTS
    auto macro_3 = UI_crt_txtbox("Tune Mode", text_alignment, test_slot_color, UI_crt_rec(test_slot_x_position+text_box_offset, 54, 150, 31, test_slot_color, UI_distance_units::pixels));
    auto macro_3_bg = UI_crt_btn(UI_crt_rec(test_slot_x_position, y_start_position+y_offset*1, 154, 35, test_slot_border_color, UI_distance_units::pixels), [this, macro_3](){ 
    ...
    auto macro_18_bg = UI_crt_btn(UI_crt_rec(test_slot_x_position, y_start_position+y_offset*6, 154, 35, test_slot_border_color, UI_distance_units::pixels), [](){ 
