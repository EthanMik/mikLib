...
motor motorLF(PORT16, ratio18_1, true);
motor motorLM(PORT17, ratio18_1, true);
motor motorLB(PORT19, ratio18_1, true);
motor_chain leftDrive = motor_chain({motorLF, motorLM, motorLB});

motor motorRF(PORT1, ratio18_1, false);
motor motorRM(PORT10, ratio18_1, false);
motor motorRB(PORT18, ratio18_1, false);
